...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css'>
  ...
  <div class="welcome" id="welcome">
    <div class="container" id="welcome_container">
      <div class="row" id="row0">
        <div class="col-md-12" class="colW">
          <h1 class="text-center" id="wel" style="padding-bottom: 10px;"><span style="color: rgba(45, 164, 125, 0.9)" id="w">Добро пожаловать!</span></h1>
          <h1 class="text-center"><span style="color: #eeaf11" class="smile">Сайт онлайн тестирования Testor</span></h1>
        </div>
        <div class="col-md-12 text-center down">
          <a href="#about"><i class="fa fa-arrow-circle-down" id="down"></i></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="about" id="about">
    <div class="container">
    <h1 class="text-center" id="aboutMe">О Нас</h1>
